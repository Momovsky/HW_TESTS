...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        with open('/Users/igorkirillov/PycharmProjects/HW_TESTS/fixtures/directories.json', 'r', encoding='utf-8') as directories:
            app.directories = json.load(directories)
        with open ('/Users/igorkirillov/PycharmProjects/HW_TESTS/fixtures/documents.json', 'r', encoding='utf-8') as documents:
